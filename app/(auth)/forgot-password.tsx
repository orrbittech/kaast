    ...
    return (
      <View className="flex-1 bg-base justify-center items-center px-6">
        <View className="w-full max-w-sm gap-4">
          ...
          {error ? (
            <Text className="text-sm text-cancel text-center">{error}</Text>
          ) : null}
          <TextInput
          ...
          <Pressable onPress={() => setStep("email")} className="self-center">
            <Text className="text-primary">Use a different email</Text>
          </Pressable>
        </View>
      </View>
    );
    ...
    <View className="flex-1 bg-base justify-center items-center px-6">
      <View className="w-full max-w-sm gap-4">
        ...
        <View className="flex-row justify-center gap-2">
          <Text className="text-zinc-400">Remember your password?</Text>
          <Link href="/sign-in" asChild>
            <Pressable>
              <Text className="font-sans-medium text-primary">Sign In</Text>
            </Pressable>
          </Link>
        </View>
      </View>
